...
Pushes to `main` run `.github/workflows/pages.yml`, deploy the root-base build to Hostinger, verify `https://aureondigital.co`, then build with the GitHub Pages base path and deploy `dist/`.
